...
//        value = new String(STRING_RESOURCE_BUNDLE.getString(key).getBytes(StandardCharsets.ISO_8859_1), StandardCharsets.UTF_8);

        value = STRING_RESOURCE_BUNDLE.getString(key);
        return value;
    }
